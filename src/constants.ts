export const NOTES: Record<string, { frequency: number; color: string; name: string }> = {
  'A': { frequency: 440.0, color: '#FF0000', name: 'A red' },  // Red
...
export const TIME_WINDOW_DECREASE = 100; // How much to decrease time window per level
